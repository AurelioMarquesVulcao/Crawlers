exports.comarcas = {
    ...
    "rs": [
        ...
        '0014', '0015', '0016', '0017', '0018', '0019', '0020',
        '0021', '0022', '0023', '0024', '0025', '0026', '0027',
        '0028', '0029', '0030', '0101', '0102', '0103', '0104',
        '0111', '0121', '0122', '0123', '0124', '0131', '0141',
        '0201', '0202', '0203', '0204', '0205', '0211', '0221',
        '0231', '0232', '0233', '0234', '0241', '0251', '0252',
        '0261', '0271', '0281', '0282', '0291', '0292', '0301',
        '0302', '0303', '0304', '0305', '0331', '0332', '0333',
        '0334', '0341', '0351', '0352', '0371', '0372', '0373',
        '0381', '0382', '0383', '0384', '0401', '0402', '0403',
        '0404', '0405', '0406', '0411', '0451', '0461', '0471',
        '0511', '0512', '0521', '0522', '0523', '0531', '0541',
        '0551', '0561', '0571', '0601', '0611', '0641',
        '0661', '0662', '0663', '0664',
        '0701', '0702', '0721', '0731',
        '0732', '0733', '0741', '0751',
        '0752', '0761', '0771', '0772',
    ...
    "pe": [
        ...
        '0101', '0102', '0103', '0121', '0122', '0141',
        '0142', '0143', '0144', '0145', '0161', '0171',
        '0172', '0181', '0182', '0191', '0192', '0193',
        '0201', '0211', '0221', '0231', '0232', '0233',
        '0241', '0242', '0251', '0261', '0262', '0271',
        '0281', '0282', '0291', '0292', '0301', '0311',
        '0312', '0313', '0331', '0341', '0351', '0361',
        '0371', '0381', '0391', '0401', '0411', '0412',
        '0413', '0906'
    ],
    // codigo 07
    "ce": [
    ...
    "pa": [
        ...
        '0129', '0130', '0131', '0132', '0201',
        '0202', '0203', '0205', '0206', '0207',
        '0208', '0209', '0210', '0900', '5555'
    ],
    // codigo 09
    "pr": [
        '0000', '0001', '0002', '0003', '0004', '0005', '0006',
        '0007', '0008', '0009', '0010', '0011', '0012', '0013',
        '0014', '0015', '0016', '0017', '0018', '0019', '0020',
        '0021', '0022', '0023', '0024', '0025', '0026', '0028',
        '0029', '0041', '0053', '0068', '0069', '0071', '0072',
        '0073', '0084', '0088', '0089', '0091', '0092', '0093',
        '0094', '0095', '0096', '0121', '0122', '0124', '0125',
        '0126', '0127', '0128', '0129', '0130', '0133', '0195',
        '0242', '0245', '0303', '0322', '0325', '0411', '0459',
        '0513', '0562', '0567', '0585', '0594', '0643', '0651',
        '0652', '0653', '0654', '0655', '0656', '0657', '0658',
        '0659', '0660', '0661', '0662', '0663', '0664', '0665',
        '0666', '0668', '0669', '0670', '0671', '0672', '0673',
        '0678', '0684', '0749', '0863', '0872', '0892', '0965',
        '3365'
    ],
    // codigo 10
    "to": [
