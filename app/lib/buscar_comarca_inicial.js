...
const CONNECTION_URL_BDV2 =
  'mongodb://admin:admin@bigrj01mon01:19000,bigrj01mon02:19001,bigrj01mon03:19000/bigDataV2?authSource=admin&replicaSet=rsBigData&readPreference=primary&appname=MongoDB%20Compass&ssl=false';
...
let consultar = (db, tribunal, ano) => {
  return new Promise((resolve, reject) => {
    ...
    let OBJ_ID = ObjectId(
      Math.floor(new Date(data) / 1000).toString(16) + '0000000000000000'
    );
