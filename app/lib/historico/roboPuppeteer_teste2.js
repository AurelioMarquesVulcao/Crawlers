...
class RoboPuppeteer3 {
  ...
  async preencheTribunal(numero) {  
    ...
    await console.log("tribunal preenchido");
  ...
  async preencheProcesso(numero, contador) {
    ...
    await console.log("o contador é " + contador);
...
//   await puppet.preencheTribunal("00106981920175150134")
...
//     await puppet.preencheProcesso(processosMG[i], i)
//   }
