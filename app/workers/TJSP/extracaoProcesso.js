...
(async () => {
  ...
  new GerenciadorFila().consumir(nomeFila, async (ch, msg) => {
    ...
    let logger = new Logger(
      'info',
      'logs/ProcessoTJSP/ProcessoTJSPInfo.log',
      {
    ...
    try{
      ...
      const resultadoExtracao = await extrator.extrair(message.NumeroProcesso, message.NumeroOab);
      ...
      const resposta = await Helper.enviarFeedback(
        ...
        console.log(err);
        throw new Error(`ProcessoTJSP - Erro ao enviar resposta ao BigData - Oab: ${message.NumeroOab}`)
      });
